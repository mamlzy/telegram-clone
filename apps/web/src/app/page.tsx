        ...
        <div className='flex items-center px-4 py-2'>
          ...
          <div className='relative flex-1'>
            <Input
              ...
              className={cn(
                'peer h-[42px] rounded-full border-neutral-300 px-10 text-base dark:border-neutral-700'
              )}
            />
            <SearchIcon className='absolute left-3 top-1/2 size-5 -translate-y-1/2 text-neutral-400 peer-focus:text-primary' />
            {search && (
              <Button
                variant='ghost'
                size='icon'
                onClick={() => setSearch('')}
                className='absolute right-0 top-1/2 size-10 -translate-y-1/2 rounded-full !text-primary'
              >
                <XIcon className='' />
              </Button>
            )}
      ...
      <div className='grid grid-cols-1 grid-rows-2'>
        ...
        <div className='self-start'>
          <span className='line-clamp-1 text-neutral-500 dark:text-neutral-400'>
            Halo, apa kabar? disana gimana wkwkwk enak?
          </span>
        </div>
      </div>
    </div>
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange} modal={false}>
      <SheetContent
        ...
        className='top-[58px] h-[calc(100svh-58px)] w-[420px] !max-w-none p-2 shadow-none'
      >
        <SheetHeader className='sr-only'>
          <SheetTitle>ChatList</SheetTitle>
